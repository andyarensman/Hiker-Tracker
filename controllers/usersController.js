...
const forgot_handle = (req, res, next) => {
  async.waterfall([
    ...
    function(token, user, done) {
      ...
      var mailOptions = {
        to: user.email,
        from: 'hiking.data.contact@gmail.com',
        subject: 'Hike Data Password Reset',
        text: 'You are receiving this because you (or someone else) have requested the reset of the password for your hiking account.\n\n' +
